        ...
        <div className="flex min-w-0 items-center gap-4 md:gap-8">
          ...
          >
            ...
            <span
              ...
              style={{
                fontFamily: "'Waltograph', 'Space Grotesk', sans-serif",
              }}
            >
              Rankistan
            </span>
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-4">
          {activeTab === "leaderboard" && (
            <div className="relative hidden lg:block mr-2">
              <input
                className="bg-surface-container-lowest border-b-2 border-outline-variant focus:border-tertiary focus:ring-0 text-sm font-mono py-1 px-3 w-64 placeholder:text-outline/50 transition-all text-on-surface"
                placeholder="Search developer..."
                type="text"
                value={searchTerm}
                onChange={(e) => onSearchChange(e.target.value)}
              />
              <span className="material-symbols-outlined absolute right-2 top-1 text-outline">
                search
              </span>
            </div>
          )}
          <div className="relative">
            <button
              ...
              className="p-2 text-[#8b919d] hover:bg-[#262a31] transition-colors duration-50 active:scale-95"
            >
              ...
              <>
                ...
                <div className="absolute right-0 top-12 z-50 w-72 bg-[#1a1f27] border border-[#414752] shadow-xl p-5 font-mono text-xs text-[#8b919d]">
                  ...
                  <p className="leading-relaxed">
                    Notifications aren't wired up yet. We're too busy ranking
                    developers to build a bell that rings.
                  </p>
                  <p className="mt-2 text-[#414752]">
          ...
          <a
            href="https://sudo-ali-dev.github.io/"
            target="_blank"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-8 h-8 flex items-center justify-center text-[#8b919d] hover:text-white transition-colors"
          >
            <svg
              viewBox="0 0 16 16"
              width="24"
